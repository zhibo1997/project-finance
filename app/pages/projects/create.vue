      ...
      <section :class="sectionClass" id="basic-info">
        ...
        <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="md:col-span-2 p-4 rounded-lg border border-gray-100 bg-gray-50">
            ...
            <!-- 这里可以使用 Nuxt UI 的多选组件 -->
            <div class="text-xs text-gray-500">可多选项目成员</div>
          </div>
          ...
          >
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pl-10">
              <div>
                ...
                <!-- 这里可以使用 Nuxt UI 的搜索选择组件 -->
                <input
                  type="text"
                  v-model="laborItems[index].name"
                  :class="inputClass"
                  placeholder="搜索员工"
                />
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pl-10">
              <div>
                ...
                <div class="relative">
                  ...
                  <div class="w-4 h-4 text-gray-400 absolute right-3 top-2.5 pointer-events-none">▼</div>
                </div>
              </div>
              <div>
