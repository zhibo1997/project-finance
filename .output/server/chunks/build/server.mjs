...
import { p as hasProtocol, q as isScriptProtocol, o as joinURL, w as withQuery, v as sanitizeStatusCode, x as getContext, $ as $fetch, y as createHooks, f as createError$1, z as isEqual, A as stringifyParsedURL, B as stringifyQuery, C as parseQuery, D as defu } from '../_/nitro.mjs';
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-3b62adcf"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C8YLmLfr.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DLtF_-3t.mjs'));
