declare global {
  ...
  const deleteFile: typeof import('../../server/utils/upload').deleteFile
  const dynamicEventHandler: typeof import('../../node_modules/h3').dynamicEventHandler
  const error: typeof import('../../server/utils/response').error
  ...
  const getFilePath: typeof import('../../server/utils/upload').getFilePath
  ...
  const saveFile: typeof import('../../server/utils/upload').saveFile
  ...
  const success: typeof import('../../server/utils/response').success
  ...
  const validateFile: typeof import('../../server/utils/upload').validateFile
...
declare global {
  ...
  // @ts-ignore
  export type { ApiResponse } from '../../server/utils/response'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'D:/项目demo/baobiao/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'D:/项目demo/baobiao/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { default as db } from 'D:/项目demo/baobiao/server/utils/db';
export { success, error } from 'D:/项目demo/baobiao/server/utils/response';
export { validateFile, saveFile, deleteFile, getFilePath } from 'D:/项目demo/baobiao/server/utils/upload';